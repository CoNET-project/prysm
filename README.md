# Prysm: An CONET Consensus Implementation Written in Go
...
This is the core repository for Prysm, a [Golang](https://golang.org/) implementation of the [CONET Consensus](https://ethereum.org/en/eth2/) specification hard fork from Ethereum Prysm, developed by [Prysmatic Labs](https://prysmaticlabs.com). See the [Changelog](https://github.com/prysmaticlabs/prysm/releases) for details of the latest releases and upcoming breaking changes.
